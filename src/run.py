...
import services
from services import log_factory
...
from services.corpus import Corpus, DataCollatorCTCWithPadding, DataPreProcessor
from services.data_loader import Json
from models.Wav2Vec import ASR
...
def evaluate():
    ...
    logger.info("""
        Done.
    """)
    services.send_notification("Evaluation Finished")
...
def train():
    ...
    t1 = time.time()
    services.send_notification("Training Started")
    if args.checkpoint:
    ...
    services.send_notification("Training Finished")
    trainer.save_state()
